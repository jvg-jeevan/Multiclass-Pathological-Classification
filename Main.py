...
def Home():
	...
	window = tk.Tk()
	window.title("Multiclass Pathology Classification in a Voice Signal")
	...
	message1 = tk.Label(window, text="Multiclass Pathology Classification in a Voice Signal" ,bg=bgcolor  ,fg=fgcolor  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
