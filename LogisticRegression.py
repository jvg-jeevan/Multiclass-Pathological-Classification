...
def process(path):
    ...
    results_df.to_csv("results/resultLogisticRegression.csv", index=False)
    ...
    metrics_df.to_csv("results/LogisticRegressionMetrics.csv", index=False)
    ...
    plt.savefig('results/LogisticRegressionMetricsValue.png')
    plt.show()
